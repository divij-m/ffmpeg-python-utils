...
if bitRate is not '0':
    ffmpegCmd = "ffmpeg -i " + fileName + " -c:v libx264 -b:v " + bitRate + " -c:a copy" + ultraFastStr + outFileName
else:
    ffmpegCmd = "ffmpeg -i " + fileName + " -c:v libx264 -c:a copy" + ultraFastStr + outFileName
